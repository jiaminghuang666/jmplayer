...
public class VideoDetailsFragment extends DetailsSupportFragment   {
    private static final String TAG = "jiaming VideoDetailsFragment";
    ...
    private void setupDetailsOverviewRow() {
        ...
        Log.d(TAG, "doInBackground: width: " + width + " height: " + height + "selectedmovie :"+ mSelectedMovie.toString());
        Glide.with(getActivity())
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    Log.d(TAG, "jiaming onActionClicked intent: " + intent);
                    Log.d(TAG, "jiaming onActionClicked mSelectedMovie: " + mSelectedMovie);
            ...
            if (item instanceof Movie) {
                ...
                Bundle bundle =
                        ActivityOptionsCompat.makeSceneTransitionAnimation(
                                ...
                                .toBundle();
                Log.d(TAG, "jiaming getActivity: " + getActivity());
