...
{
    ALOGD("XShader::Init XShaderType = %d \n",type);
    Close();
    ...
    {
        mux.unlock();
        ALOGD("InitShader GL_FRAGMENT_SHADER failed!");
        return false;
    }

    ALOGD("InitShader fsh success \n");
